...
const rows = [
    createData(`CE.1 - Identifeir`, 0, 'ID', 'O','-'),
    createData(`CE.2 - Text`, 0, 'ST', 'O','-'),
    createData(`CE.3 - Name Of Coding System`, 0, 'ST', 'O','-'),
    createData(`CE.4 - Alternate Identifier`, 0, 'ST', 'O','-'),
    createData(`CE.5 - Alternate Text`, 0, 'ST', 'O','-'),
    createData(`CE.6 - Name Of Alternate Coding System`, 0, 'ST', 'O','-'),
];

const DataTypeDefinitionScreen = () => {
...
export default DataTypeDefinitionScreen;
